...
func (*jsonMarshalerEncoder2) Encode2(v reflect.Value, s *Streamer, opts *EncOpts) {
	o := v.Interface()
...
type jsonPointerMarshalerEncoder2 struct{}

func (*jsonPointerMarshalerEncoder2) Encode2(v reflect.Value, s *Streamer, opts *EncOpts) {
	if v.IsNil() {
		s.Null()
		return
	}
